...
csv_file_0_50 = cwd + '/src/dlcv/results/Test_Semantic_Segmentation_10Epochs_Deeplabv3plus.csv'  
csv_file_51_100 = cwd + '/src/dlcv/results/Test_Semantic_Segmentation_10-50Epochs_Deeplabv3plus.csv'  
